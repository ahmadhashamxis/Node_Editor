...
const OutputNode = ({ data }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-100 to-purple-200 text-center p-4  text-black text-2xl font-semibold rounded-3xl w-[200px] h-[150px]">
      <p className="mb-2 mt-[20%] text-purple-800">OUTPUT</p>
      {/* {data.detectedImage && (
        <img
